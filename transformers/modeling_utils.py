...
class PreTrainedModel(nn.Module):
    ...
    def decode(self,
        ...
        return self._greedy_decode_or_sample(prompt_ids, length, sampler_config, device, **model_kwargs)

    def _greedy_decode_or_sample(self, prompt_ids, length, sampler_config, device, **model_kwargs):
...
class Sampler(object):
    ...
    def __init__(
        self, device, do_sample=False, k=9, p=0.0, temperature=1.0, repetition_penalty=1.0
    ):
        self.k = k
        self.p = p
